...
from archibald.numpy.array import array, zeros_like
from archibald.numpy.conditionals import where
from archibald.numpy.logicals import all, any, logical_or
