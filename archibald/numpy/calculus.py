...
from archibald.numpy.determine_type import is_casadi_type
from archibald.numpy.arithmetic_dyadic import centered_mod as _centered_mod
from archibald.numpy.array import array, concatenate, reshape
    ...
    Args:
        ...
        *varargs: The spacing between the points of f. If a scalar, the spacing is assumed to be uniform in all
        ...
        period: The period of the data. If provided, the gradient is taken assuming the data "wraps around" at the period
            (i.e., modulo the period). See `archibald.numpy.diff()` for more information.
