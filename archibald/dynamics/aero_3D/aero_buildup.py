...
import archibald.library.aerodynamics as aero
import archibald.numpy as np
from archibald.dynamics.aero_3D.aero_buildup_submodels.fuselage_aerodynamics_utilities import *
from archibald.library.aerodynamics import transonic
import archibald.library.aerodynamics as aerolib
from typing import Union, List, Dict
from archibald.dynamics.aero_3D.aero_buildup_submodels.softmax_scalefree import (
    softmax_scalefree,
)
...
if __name__ == "__main__":
    from archibald.dynamics.aero_3D.test_aero_3D.geometries.conventional import (
        airplane,
    )
