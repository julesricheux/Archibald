...
def black_box(
    ...
    """
    Wraps a function as a black box, allowing it to be used in Archibald / CasADi optimization problems.
...
if __name__ == "__main__":
    ### Create a function that's effectively black-box (doesn't use `archibald.numpy`)
    def my_func(
        a1,
        a2,
        k1=4,
