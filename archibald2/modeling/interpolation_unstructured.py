...
from archibald2.modeling.interpolation import InterpolatedModel
...
class UnstructuredInterpolatedModel(InterpolatedModel):
    ...
    def __init__(
        ...
        Args:
            ...
            Also a dictionary. See archibald2.InterpolatedModel for documentation on possible inputs here.
