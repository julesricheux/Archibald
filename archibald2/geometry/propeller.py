...
class BSeriesPropeller(Propeller):
    def __init__(self,
        ...
        ktDatapath = os.path.join(current, 'propeller\\b-series-kt.csv')
        kqDatapath = os.path.join(current, 'propeller\\b-series-kq.csv')
        V1Datapath = os.path.join(current, 'propeller\\b-series-v1.csv')
        V2Datapath = os.path.join(current, 'propeller\\b-series-v2.csv')
        geometryDatapath = os.path.join(current, 'propeller\\b-series-geometry.csv')
