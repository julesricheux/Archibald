...
Citation:
    Adapted from:         geometry.wing module in AeroSandbox
...
from archibald2.tools.math_utils import rotate_points, rotate_single_vector
import copy
...
if __name__ == '__main__':
    ...
    airfoils = [Airfoil("naca0012"),
                Airfoil("naca0012"),
                Airfoil("naca0012"),]
    
    lp = LiftingDevice(name='test',
              xyz_le=le,
              chords=chords,
              twists=twists,
              canting=45.,
    ...
    lp.global_rotation(angle=-15., axis=[0.,0.,1.], center=np.zeros(3), offset_deflection=True)
